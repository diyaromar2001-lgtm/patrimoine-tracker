              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="flex items-center gap-1.5 text-[11px]" style={{ color: "#f59e0b" }}>
                    <span className="h-0.5 w-4 inline-block border-t-2 border-dashed" style={{ borderColor: "#f59e0b" }} /> Lump Sum
                  </span>
                </div>
              </div>
              <DCAChart dcaData={res.dcaPts} lumpData={res.lumpPts} height={200} />
            </div>
