-- ════════════════════════════════════════════════════════════════════════════════
-- UPGRADE LOT 2: Ajouter colonnes, tables, et RPC manquantes
-- Source: Commit 38e6adc (import_csv_batch, recalculate_asset_position, rollback_import_batch)
-- Source: Commit 04e83b5 (create_portfolio_and_import_trading212)
--
-- Cette migration ajoute UNIQUEMENT les composants manquants.
-- Elle reprend le code complètement testé de 38e6adc.
-- ════════════════════════════════════════════════════════════════════════════════

-- EXTRACTION DU FICHIER 38e6adc
-- ════════════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════════════
-- SECTION 6: ATOMIC PORTFOLIO CREATION + IMPORT
-- Source: Commit 04e83b5
-- ════════════════════════════════════════════════════════════════════════════════
